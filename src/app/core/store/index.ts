...
import * as fromListingsShortDetail   from '@core/store/listings-short-detail/listing-short-detail.reducer'
import * as fromCategories            from '@core/store/categories/categories.reducer'
